...
curl -sSL https://raw.githubusercontent.com/scintillium/sub2api/main/deploy/docker-deploy.sh | bash

# Or download first, then run
curl -sSL https://raw.githubusercontent.com/scintillium/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
```bash
# Clone repository
git clone https://github.com/scintillium/sub2api.git
cd sub2api/deploy
