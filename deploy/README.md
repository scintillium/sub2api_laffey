...
curl -sSL https://raw.githubusercontent.com/scintillium/sub2api_laffey/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/scintillium/sub2api_laffey/releases)
